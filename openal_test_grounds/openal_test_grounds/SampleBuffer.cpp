...
SampleBuffer* SampleBuffer::get()
{
	static SampleBuffer* sampleBuffer = new SampleBuffer();
	return sampleBuffer;
}

/* Make this a buffer middle man - Takes file, or array, with a switch arg */
ALuint SampleBuffer::play_sample_and_increase_history(const char* fileName)
{
	SNDFILE* sampleFile;
...
bool SampleBuffer::remove_a_sample_from_this_history(const ALuint& sample)
{
